...
df = pd.read_csv("IMMUcan_before_filtering/Assignment_Solution/Activities/Assignment_Solution_Activities.txt", sep='\t')
#df = pd.read_csv("SYNERGY_before_filtering/Assignment_Solution/Activities/Assignment_Solution_Activities.txt", sep='\t')
